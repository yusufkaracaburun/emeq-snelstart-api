---
url: https://b2bapi-developer.snelstart.nl/apidocumentatie
title: API DOCUMENTATIE - Microsoft Azure API Management - developer portal
...
De eenvoudigste manier is om het grant\_type op "clientkey" te zetten en de koppelingssleutel in het property clientkey mee te sturen. Hieronder volgt een voorbeeld van een request met grant\_type "clientkey". Een voorbeeld voor het grant\_type "password" is [hier](#) te vinden  
.  
